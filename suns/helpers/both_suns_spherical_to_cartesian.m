...
for i = 1:numel(files)
    ...
    zzz = [];
    for jj=1:size(z_ref)
        zzz(:, jj) = Rz*[rad2deg(x_ref(jj)), rad2deg(y_ref(jj)), rad2deg(z_ref(jj))]';
    end
    ...
    plot(suns_exp.timestamp_als_1/60, rad2deg(x_exp_1), '.');
    plot(suns_exp.timestamp_als_2/60, rad2deg(x_exp_2), '.');
    plot(suns_exp.timestamp_als_3/60, rad2deg(x_exp_3), '.');
    ...
    plot(suns_exp.timestamp_als_1/60, rad2deg(y_exp_1), '.');
    plot(suns_exp.timestamp_als_2/60, rad2deg(y_exp_2), '.');
    plot(suns_exp.timestamp_als_3/60, rad2deg(y_exp_3), '.');
    ...
    plot(suns_exp.timestamp_als_1/60, rad2deg(z_exp_1), '.');
    plot(suns_exp.timestamp_als_2/60, rad2deg(z_exp_2), '.');
    plot(suns_exp.timestamp_als_3/60, rad2deg(z_exp_3), '.');
    ...
    all_results.suns_exp_z_als_1 = rad2deg(z_exp_1);
    all_results.suns_exp_z_als_2 = rad2deg(z_exp_2);
    all_results.suns_exp_z_als_3 = rad2deg(z_exp_3);
    
    all_results.suns_exp_y_als_1 = rad2deg(y_exp_1);
    all_results.suns_exp_y_als_2 = rad2deg(y_exp_2);
    all_results.suns_exp_y_als_3 = rad2deg(y_exp_3);
    
    all_results.suns_exp_x_als_1 = rad2deg(x_exp_1);
    all_results.suns_exp_x_als_2 = rad2deg(x_exp_2);
    all_results.suns_exp_x_als_3 = rad2deg(x_exp_3);
